...
// or CharSequence.  We created ImmutableString class in the last topic.
    ...
    private static void testCaseInvalid(){
        System.out.println("--------- INVALID CONCAT --------");
        int anInt = 100;
        //anInt += helloString; // INVALID
        System.out.println("anInt = " + anInt);
    }

    private static void testCaseNumbers(){
        System.out.println("--------- STRING CONCAT WITH NUMBERS --------");
        String helloString = "hello";
        int anInt = 100;
